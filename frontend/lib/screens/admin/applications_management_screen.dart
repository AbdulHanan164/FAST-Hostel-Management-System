...
class _ApplicationsManagementScreenState extends ConsumerState<ApplicationsManagementScreen> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<HostelApplicationModel>>(
        ...
        builder: (context, snapshot) {
          ...
          // Sort by queue number ascending (FIFO); 0 = legacy apps go last
          applications.sort((a, b) {
            final qa = a.queueNumber == 0 ? 999999 : a.queueNumber;
            final qb = b.queueNumber == 0 ? 999999 : b.queueNumber;
              ...
              return Card(
                ...
                child: ExpansionTile(
                  leading: Container(
                    ...
                    child: Text(
                      application.queueNumber > 0 ? '#${application.queueNumber}' : '?',
                      style: TextStyle(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Application Details
                          _buildDetailRow('Queue Position', application.queueNumber > 0 ? '#${application.queueNumber}' : 'N/A (legacy)'),
  ...
  Future<void> _assignRoom(HostelApplicationModel application) async {
    if (!mounted) return;
    // Navigate to centralized Room Requests screen where admin approves student-selected rooms
