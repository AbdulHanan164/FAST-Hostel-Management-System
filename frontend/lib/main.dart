...
void main() async {
  ...
  try {
    ...
    // Initialize local notifications (optional - continue if it fails)
    try {
...
/// Hides scrollbars on all platforms while keeping scroll physics intact.
class _NoScrollbarBehavior extends ScrollBehavior {
  const _NoScrollbarBehavior();

  @override
  Widget buildScrollbar(BuildContext context, Widget child, ScrollableDetails details) {
    // Return child directly — no scrollbar overlay on any platform
    return child;
  }
}
