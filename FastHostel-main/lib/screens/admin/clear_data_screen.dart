  ...
  Future<void> _performClear() async {
    ...
    try {
      ...
      if (_clearApplications) {
        ...
        _addLog('✓ Deleted $n hostel application(s)');
      }
      ...
      if (_clearPayments) {
        ...
        _addLog('✓ Deleted ${n1 + n2} payment record(s)');
      }
      ...
      if (_clearGym) {
        ...
        await batch.commit();
        _addLog('✓ Deleted ${gymDocs.docs.length} gym registration(s)');
      }
      ...
      if (_clearMess) {
        ...
        await batch.commit();
        _addLog('✓ Deleted ${messDocs.docs.length} mess registration(s)');
      }
      ...
      if (_resetRooms) {
        ...
        await batch.commit();
        _addLog('✓ Reset ${roomDocs.docs.length} room(s)');
      }
