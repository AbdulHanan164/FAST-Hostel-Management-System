          ...
          children: [
            ...
            StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, balSnap) {
                if (!balSnap.hasData || !balSnap.data!.exists) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: remaining > 0 ? Colors.orange.shade300 : Colors.green.shade300,
                    ),
                  ),
                  child: Row(
                    children: [
                      Icon(
                        remaining > 0 ? Icons.warning_amber_rounded : Icons.savings_outlined,
                      ...
                      Expanded(
                        child: remaining > 0
                            ...
                            : Text(
                                'Credit Balance: Rs. ${credit.toStringAsFixed(0)}\nThis will be deducted from your next challan.',
            ...
            if (payments.isEmpty)
              const Expanded(child: Center(child: Text('No due payments')))
            else
              Expanded(
